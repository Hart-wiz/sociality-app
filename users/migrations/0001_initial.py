    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_url', models.ImageField(blank=True, upload_to='profiles/')),
            ...
            options={
                'indexes': [models.Index(fields=['username'], name='users_custo_usernam_a8ad03_idx'), models.Index(fields=['email'], name='users_custo_email_c80f75_idx')],
            },
            managers=[
